...
- **Answer Relevancy 均分**: 0.822
- **Faithfulness 均分**: 0.886
- **Contextual Precision 均分**: 0.228

### RAGAS

- **Faithfulness（忠实度）**: 0.754
- **Context Precision（检索精度）**: 0.070
- **Context Recall（检索召回）**: 0.266
- **Answer Relevancy（回答相关性）**: 0.486

## DeepEval · 按法律类别分组

### 劳动法

- Answer Relevancy: 0.822
- Faithfulness: 0.886
- Contextual Precision: 0.228
...
- **劳动合同期满，用人单位不续签，需要支付经济补偿金吗？...** [劳动法/easy]
  未通过: Answer Relevancy, Faithfulness, Contextual Precision
