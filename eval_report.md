...
- **Answer Relevancy 均分**: 0.871
- **Faithfulness 均分**: 0.972
- **Contextual Precision 均分**: 0.261

### RAGAS

- **Faithfulness（忠实度）**: 0.584
- **Context Precision（检索精度）**: 0.050
- **Context Recall（检索召回）**: 0.299
- **Answer Relevancy（回答相关性）**: 0.481
