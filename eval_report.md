...
- **Answer Relevancy 均分**: 0.766
- **Faithfulness 均分**: 0.934
- **Contextual Precision 均分**: 0.262

### RAGAS

- **Faithfulness（忠实度）**: nan
- **Context Precision（检索精度）**: nan
- **Context Recall（检索召回）**: 0.240
- **Answer Relevancy（回答相关性）**: 0.554
